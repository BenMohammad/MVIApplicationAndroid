...
import com.benmohammad.mviapp.data.source.local.TasksPersistenceContract.TaskEntry
...
class TasksLocalDataSource private constructor(
    ...
    override fun completeTask(taskId: String): Completable {
        ...
        val selectionsArgs = arrayOf(taskId)
        databaseHelper.update(TaskEntry.TABLE_NAME, values, selection, *selectionsArgs)
        return Completable.complete()
    }
