...
import com.benmohammad.mviapp.addedittask.AddEditTaskAction.*
import com.benmohammad.mviapp.addedittask.AddEditTaskResult.*
                    ...
                    Observable.merge(
                        ...
                        task.filter { !it.empty }.flatMap {
                            tasksRepository.saveTask(it)
                                .andThen(Observable.just(CreateTaskResult.Success))
                        }
                    )
                }
        }
